#!/usr/bin/env python3
"""Stage repo-owned MAX78000 TallyQA count training files into ai8x-training."""
...
FILES = (
    ...
    (
        Path("max78000/ai8x_training/datasets/tallyqa_count.py"),
        Path("datasets/tallyqa_count.py"),
    ),
    (
        Path("max78000/ai8x_training/policies/qat_policy_tallyqa_count.yaml"),
    ...
    (
        Path("max78000/ai8x_training/policies/qat_policy_tallyqa_count_start15.yaml"),
        Path("policies/qat_policy_tallyqa_count_start15.yaml"),
    ),
    (
    ...
    (
        Path("max78000/ai8x_training/policies/schedule-tallyqa-count-30ep-warmup.yaml"),
        Path("policies/schedule-tallyqa-count-30ep-warmup.yaml"),
    ),
    (
    ...
    (
        Path("max78000/ai8x_training/policies/schedule-tallyqa-count-20ep-warmup.yaml"),
        Path("policies/schedule-tallyqa-count-20ep-warmup.yaml"),
    ),
)
